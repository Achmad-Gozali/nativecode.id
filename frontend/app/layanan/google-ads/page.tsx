...
const paket = [
  ...
  { harga: 'Rp. 1.577.000', nama: 'Paket GALAXY MINGGUAN 100rb/hari', perpanjangan: 'Perpanjangan Rp. 1.077.000/Minggu', badge: null, detail: ['Saldo iklan Ads: 700rb', 'Biaya perhari: 100 ribu', 'Lama tayang Iklan Google: 7 hari', 'Free analist keywords/kata kunci', 'Free konsultasi', 'Biaya pajak 11%: 77 ribu', 'Biaya Fee: 300 ribu', 'Biaya pembuatan akun khusus VVIP: 300rb', 'Biaya registrasi 200 ribu (1X bayar saja)', 'Biaya perpanjangan: 1.077.000,-/minggu (sudah termasuk pajak 11%)'] },
...
const faq = [
  { q: 'Apa itu Google Ads dan kenapa bisnis saya perlu beriklan di sana?', a: 'Google Ads adalah platform iklan berbayar milik Google yang memungkinkan bisnis Anda muncul di halaman pertama hasil pencarian Google. Dengan Google Ads, iklan Anda hanya ditampilkan kepada orang-orang yang sedang aktif mencari produk atau jasa yang Anda tawarkan — sehingga lebih efektif dan tepat sasaran dibanding iklan konvensional.' },
  { q: 'Berapa lama iklan saya mulai tayang setelah pembayaran?', a: 'Estimasi waktu penayangan iklan di Google berkisar antara 8 hingga 24 jam setelah pendaftaran dan pembayaran berhasil diproses. Iklan akan kami setup dan aktifkan secepatnya setelah semua data dan materi iklan diterima.' },
  { q: 'Apakah saya perlu punya website untuk beriklan di Google Ads?', a: 'Ya, umumnya Google Ads memerlukan landing page atau website sebagai tujuan iklan. Jika Anda belum memiliki website, kami juga menyediakan jasa pembuatan website profesional yang bisa dikombinasikan dengan paket Google Ads untuk hasil yang lebih optimal.' },
  { q: 'Apa bedanya akun VVIP dengan akun biasa?', a: 'Akun VVIP adalah akun Google Ads khusus yang dibuat terpisah untuk bisnis Anda. Keuntungannya: iklan Anda tidak bergabung atau terpengaruh oleh akun lain, sehingga jika ada pemain iklan lain yang melakukan kecurangan (misal: klik ilegal), hal tersebut tidak akan berimbas ke akun iklan Anda.' },
  { q: 'Apakah ada garansi iklan saya muncul di halaman pertama Google?', a: 'Google Ads bekerja berdasarkan sistem lelang kata kunci. Kami mengoptimalkan kampanye Anda agar memiliki peluang tayang yang maksimal. Namun posisi tayang juga dipengaruhi oleh kompetitor dan anggaran iklan. Yang kami jamin adalah iklan Anda akan tayang dan mendapatkan impresi sesuai target yang telah disepakati.' },
  { q: 'Apa yang dimaksud dengan biaya pajak 11% dalam paket?', a: 'Google sebagai platform asing mengenakan PPN (Pajak Pertambahan Nilai) sebesar 11% atas setiap transaksi pembelian saldo iklan. Biaya pajak ini ditetapkan oleh pemerintah Indonesia dan langsung dipotong dari saldo iklan Anda. Kami mencantumkannya secara transparan dalam setiap paket agar tidak ada biaya tersembunyi.' },
];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 pt-16">
        ...
        >
          <h1 className="fade-up text-2xl sm:text-5xl font-bold text-gray-900 mb-3">Iklan Google Ads</h1>
        ...
        <section id="paket" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-16">
          <h2 className="fade-up text-2xl sm:text-3xl font-bold text-center text-gray-900 mb-2">Paket Iklan Google Ads</h2>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-14 sm:pb-20 w-full">
          ...
          <p className="fade-up stagger-1 text-center text-gray-500 mb-8 sm:mb-10 text-sm sm:text-base">Semua yang perlu Anda tahu tentang layanan Google Ads kami</p>
