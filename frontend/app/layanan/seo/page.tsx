...
const faq = [
  {
    q: 'Apa itu SEO dan kenapa penting untuk bisnis saya?',
    a: 'SEO (Search Engine Optimization) adalah proses mengoptimalkan website agar muncul di posisi teratas hasil pencarian Google secara organik (tanpa bayar per klik). Dengan SEO, bisnis Anda bisa ditemukan oleh calon pelanggan yang sedang aktif mencari produk atau jasa Anda — menghasilkan traffic berkualitas tinggi secara konsisten dan jangka panjang.',
  },
  {
    q: 'Berapa lama hasil SEO mulai terlihat?',
    a: 'SEO adalah investasi jangka panjang. Umumnya hasil awal mulai terlihat dalam 1–3 bulan, tergantung tingkat persaingan kata kunci dan kondisi website. Itulah kenapa kami menetapkan kontrak minimal 1 tahun — agar optimasi bisa dilakukan secara menyeluruh dan hasilnya stabil di pencarian Google.',
  },
  {
  ...
  },
  {
    ...
    a: 'Jika pembayaran tidak dilanjutkan, layanan optimasi (SEO) akan kami hentikan. Website akan tetap aktif, namun kami tidak bertanggung jawab atas penurunan peringkat atau trafik karena tidak adanya pemeliharaan rutin.',
  },
  {
    q: 'Berapa banyak kata kunci yang dioptimasi?',
    a: 'Setiap paket SEO mencakup optimasi untuk 5 macam keyword/kata kunci utama sesuai target pasar bisnis Anda, ditambah kata kunci bonus. Pemilihan keyword dilakukan melalui riset mendalam untuk memastikan kata kunci yang dipilih memiliki volume pencarian tinggi dan relevan dengan bisnis Anda.',
  },
  {
    q: 'Apakah saya mendapatkan laporan perkembangan SEO?',
    a: 'Ya! Setiap klien mendapatkan laporan resmi menggunakan tool premium Rank Tracker — tools SEO berbayar yang melacak peringkat website, traffic, dan performa kata kunci secara akurat. Laporan ini diberikan secara berkala agar Anda bisa memantau perkembangan SEO website Anda secara transparan.',
  },
];
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 pt-16">
            ...
            <div className="bg-gradient-to-br from-[#e8f5e9] to-[#fff8f0] rounded-3xl p-4 sm:p-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 items-start">
                {paketSEO.map((p, i) => {
                  ...
                  return (
                    <div key={key} className={`bg-gradient-to-b ${p.warna} rounded-2xl border border-gray-100 shadow-sm flex flex-col overflow-hidden`}>
                      <div className="p-5 sm:p-6 flex flex-col flex-1">
                        ...
                        <button
                          ...
                          className="w-full py-2 text-sm text-gray-400 border border-gray-200 rounded-full hover:border-[#5D9C76] hover:text-[#5D9C76] transition-colors mb-3 flex items-center justify-center gap-1"
                        >
                          ...
                          <div className="mb-4 border border-gray-100 rounded-xl p-4 bg-white text-sm text-gray-600 leading-relaxed">
                            ...
                            {p.detail.isFitur ? (
                              ...
                              <ol className="space-y-2 list-decimal list-inside">
                                {p.detail.poin.map((poin, idx) => (<li key={idx}>{poin}</li>))}
                              </ol>
                            )}
                          </div>
                        )}
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 pb-14 sm:pb-20 w-full">
          ...
          <p className="text-center text-gray-500 mb-8 sm:mb-10 text-sm sm:text-base">Semua yang perlu Anda tahu tentang layanan SEO kami</p>
