...
const paket = [
  {
    nama: 'Starter', medal: '/images/paket/silver.png', harga: '750K', satuan: '', warna: 'from-gray-50 to-white', bestSeller: false,
  ...
  {
    nama: 'Pro', medal: '/images/paket/gold.png', harga: '2 Jt', satuan: '', warna: 'from-[#fffbe6] to-white', bestSeller: true,
  ...
  {
    nama: 'Business', medal: '/images/paket/diamond.png', harga: '5 Jt', satuan: '', warna: 'from-[#e8f5e9] to-white', bestSeller: false,
  ...
  {
    nama: 'Enterprise', medal: '/images/paket/platinum.png', harga: 'Custom', satuan: '', warna: 'from-[#fef3e8] to-white', bestSeller: false,
      ...
      <main className="min-h-screen bg-gray-50 pt-16">
        ...
        <section className="py-10 sm:py-20 px-4" style={{ background: 'linear-gradient(to bottom, #e8f5e9, #fffde7, #fff8f0)' }}>
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
              {fitur.map((f, i) => (
                <div key={i} className={`fade-up stagger-${(i % 2) + 1} bg-white rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow flex flex-col gap-4`}>
        ...
        <section id="paket" className="bg-gradient-to-br from-[#f0faf3] to-[#fff8f0] py-10 sm:py-20 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 items-start">
              {paket.map((p, idx) => {
                ...
                return (
                  <div
                    key={p.nama}
                    className={`fade-up stagger-${idx + 1} relative rounded-2xl bg-gradient-to-b ${p.warna} border ${p.bestSeller ? 'border-[#5D9C76] shadow-xl sm:scale-105' : 'border-gray-200 shadow-sm'} overflow-hidden flex flex-col`}
                  >
                    {p.bestSeller && (
            ...
            {/* CTA */}
            <div className="fade-up mt-10 sm:mt-14 bg-[#5D9C76] rounded-3xl p-6 sm:p-10 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
              <div>
