      ...
      <main className="min-h-screen bg-gray-50 pt-16">
        ...
        <section className="py-12 sm:py-20 px-4 bg-white">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8 sm:mb-10">
              ...
              <p className="text-gray-500 text-xs sm:text-base">Berbagai keuntungan yang Anda dapatkan dengan membeli domain .ID melalui rekomendasi pixelcodedigital.id</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-6 sm:gap-y-8">
              {[
                ...
                { title: 'Support 24/7', desc: 'Konsultasikan kebutuhan domain Anda dengan tim pixelcodedigital.id sebelum membeli. Setelah pembelian, DomaiNesia siap memberikan dukungan teknis 24/7.', svg: <svg viewBox="0 0 64 64" width="48" height="48" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="32" cy="32" r="28" fill="#EAF4FB"/><path d="M20 34v-4a12 12 0 0 1 24 0v4" stroke="#5BAAD0" strokeWidth="2.5" fill="none"/><rect x="16" y="33" width="7" height="9" rx="2" fill="#C9E8F7" stroke="#5BAAD0" strokeWidth="2"/><rect x="41" y="33" width="7" height="9" rx="2" fill="#C9E8F7" stroke="#5BAAD0" strokeWidth="2"/><path d="M44 42v1a4 4 0 0 1-4 4h-4" stroke="#5BAAD0" strokeWidth="2" strokeLinecap="round"/><circle cx="36" cy="47" r="2" fill="#5BAAD0"/></svg> },
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              <div className="lg:w-64 flex-shrink-0">
                <h2 className="text-xl sm:text-3xl font-bold text-gray-900 mb-3">Kenapa Beli Domain .ID Lewat pixelcodedigital.id?</h2>
              ...
              <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-5">
                {[
                  ...
                  { title: 'Konsultasi Gratis', desc: 'Tim pixelcodedigital.id siap membantu Anda memilih domain yang paling sesuai dengan kebutuhan bisnis Anda — gratis, tanpa biaya konsultasi!' },
                ].map((c, i) => (
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-20 w-full">
          <div className="flex flex-col sm:flex-row items-center gap-4 bg-white border border-gray-100 rounded-2xl shadow-sm px-5 py-4">
            <p className="flex-1 text-sm text-gray-500 text-center sm:text-left">Bingung pilih domain .ID yang tepat? Tanya dulu ke tim pixelcodedigital.id — gratis.</p>
            <a href="https://wa.me/6282249244647?text=Halo+pixelcodedigital.id%2C+saya+ingin+konsultasi+mengenai+domain+Indonesia.+Mohon+bantuannya+%F0%9F%99%8F" target="_blank" rel="noopener noreferrer"
